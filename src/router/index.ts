...
const publicRoutes: Array<RouteRecordRaw> = [
  {
    path: '/classification',
    name: 'classification',
    component: () => import('../components/user/classification.vue'),
    meta: { title: '分类', roles: ['admin', 'user', 'guest', 'su-admin'] },
  },
  {
    path: '/search',
    name: 'SearchPage',
    component: () => import('../components/user/SearchPage.vue'),
    meta: { title: '搜索', roles: ['admin', 'user', 'guest', 'su-admin'] },
  },
  {
    path: '/reportPage',
    name: 'ReportPage',
    component: () => import('../components/user/ReportPage.vue'),
    meta: { title: '举报', roles: ['admin', 'user', 'guest', 'su-admin'] },
  },
  {
    path: '/readNote',
    name: 'ReadNote',
    component: () => import('../components/user/ReadNote.vue'),
...
export const asyncRoutes: Array<RouteRecordRaw> = [
  ...
  },
  {
    path: '/updUserNote',
    name: 'UpdUserNote',
    component: () => import('../components/user/UpdUserNote.vue'),
    meta: { title: '更新笔记', roles: ['admin', 'user', 'su-admin'] },
  },
  {
    path: '/updUserNoteMd',
    name: 'UpdUserNoteMd',
    component: () => import('../components/user/UpdUserNoteMd.vue'),
    meta: { title: '更新笔记', roles: ['admin', 'user', 'su-admin'] },
  },
  {
    path: '/updPE/:showInfo',
    name: 'UpdPE',
    component: () => import('../components/user/UpdPE.vue'),
  ...
  },
  {
    path: '/mdEditor',
    name: 'MdEditor',
    component: () => import('../components/user/MdEditor.vue'),
    meta: { title: '编辑笔记', roles: ['admin', 'user', 'su-admin'] },
  },
  {
    path: '/write',
    name: 'WriteNote',
    component: () => import('../components/user/NoteEditor.vue'),
    meta: { title: '写笔记', roles: ['admin', 'user', 'su-admin'] },
  },
  {
    path: '/404',
    name: 'Page_404',
    component: () => import('../components/user/Page_404.vue'),
